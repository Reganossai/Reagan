  ...
  return (
    <div>
      <nav className="first-conti">
        ...
        <hr className="hirrr" />
        <div className="olo">
          <h1><Link to="/men">Male clothings</Link></h1>
          <h1><Link to="/women">Female clothings</Link></h1>
          <h1><Link to="/electronics">Electronics/Gadgets</Link></h1>
          <h1><Link to="/jewelery">Jewelery</Link></h1>
